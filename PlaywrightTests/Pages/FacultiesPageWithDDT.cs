...
namespace TF.Pages
{
    public class FacultiesPageWithDDT
    {
        ...
        public FacultiesPageWithDDT(IPage page)
        {
            _page = page;
        ...
        public async Task CreateFaculty(string facultyarabicname, string facultyenglishname)
        {
            await facultyCreatBtn.ClickAsync();
            await Task.Delay(1000);
            await facultyArabicName.FillAsync(facultyarabicname);
            await Task.Delay(1000);
            await facultyEnglishName.FillAsync(facultyenglishname);
            await Task.Delay(1000);
        ...
        public async Task Searchonfaculties(string facultysearchname)
        {
            ...
            await _page.GetByRole(AriaRole.Textbox).FillAsync(facultysearchname);
