...
namespace TF.Pages
{
    public class InsurancePakagesWithDDT
    {
        ...
        public InsurancePakagesWithDDT(IPage page)
        {
            _page = page;
        ...
        public async Task Createinsurancecompanies(string insurancepackageenglishname, string insurancepackagearabicname)
        {
            await InsurancePakagesCreatBtn.ClickAsync();
            await Task.Delay(2000);
            await InsurancePakagesEnglishName.FillAsync(insurancepackageenglishname);
            await InsurancePakagesArabicName.FillAsync(insurancepackagearabicname);
        ...
        public async Task InsurancePakagesSearch(string insurancepackagesearchname)
        {
            await _page.GetByLabel("Name").ClickAsync();

            await _page.GetByLabel("Name").FillAsync(insurancepackagesearchname);
