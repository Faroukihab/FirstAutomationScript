...
namespace PlaywrightTests.Pages
{
    public  class RequestType
    {
        ...
        public async Task CreateaRequest()
        {
            await _CreateRequestBtn.ClickAsync();
            await _EnglishNameField.FillAsync("summer vaaaaac");
            await _ArabicNameField.FillAsync("صيف اجازةةةةةة");
            await _ResponsetimeField.FillAsync("16");
        ...
        public async Task SearchonCreatedRequested()
        {
            await _SearchNamefield.FillAsync("holliday");
            await Task.Delay(1000);
