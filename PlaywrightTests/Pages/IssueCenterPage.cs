...
public class IssueCenterPage
{
    ...
    public IssueCenterPage(IPage page)
    {
        _page = page;
    ...
    public async Task CreateIssueCenter()
    {
        await CreatBtn.ClickAsync();
        await EnglishName.FillAsync("test13");
        await ArabicName.FillAsync("3تيست1");
    ...
    public async Task SeachOnIssueCenter()
    {
        await SearhByName.FillAsync("امبابة");
