...
namespace TF.Pages
{
    public class ProffessionWithDDT
    {
        ...
        public ProffessionWithDDT(IPage page)
        {
            _page = page;
        ...
        public async Task CreateProffesssion(string proArabicName, string proEnglishName)
        {
            await ProCreatBtn.ClickAsync();
            await ProArabicName.FillAsync(proArabicName);
            await ProEnglishName.FillAsync(proEnglishName);
