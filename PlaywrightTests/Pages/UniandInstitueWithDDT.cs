...
namespace TF.Pages
{
    public class UnivercitiesAndInstitueWithDDT
    {
        IPage _page;
        private IPage page;
        ...
        public UnivercitiesAndInstitueWithDDT(IPage page)
        ...
        public async Task CreateNewUni(string UnienglishName, string UniarabicName )
        {
            await UniCreatBtn.ClickAsync();
            await UniEnglishName.FillAsync(UnienglishName);
            await UniArabicName.FillAsync(UniarabicName);
        ...
        public async Task SearchOnUni(string SearchNameUni)
        {
            ...
            await _page.GetByRole(AriaRole.Textbox).FillAsync(SearchNameUni);
