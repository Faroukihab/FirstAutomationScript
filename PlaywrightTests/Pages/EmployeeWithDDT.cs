...
namespace TF.Pages
{
    public class EmployeeWithDDT
    {
        ...
        public EmployeeWithDDT(IPage page)
        {
            _page = page;
        ...
        public async Task SeachOnEmployee(string EmployeeSearchName)
        {
            await _SearchBanksbyName.FillAsync(EmployeeSearchName);
        ...
        public async Task CreateNewEmp(string EmployeeArabicName, string EmployeeEnglishName, string IDIssueNumber, string EmployeeArabicAddress , string EmployeeEnglishAddress, string EmployeeNameonBank, string 
            AccountNo, string EmployeeID, string MilitaryNo, string EmployeeName)
        {
            await _page.GetByRole(AriaRole.Button, new() { Name = "Create" }).ClickAsync();

            await _page.GetByLabel("Arabic Name *").ClickAsync();

            await _page.GetByLabel("Arabic Name *").FillAsync(EmployeeArabicName);

            await _page.GetByLabel("Arabic Name *").PressAsync("Tab");

            await _page.GetByLabel("English Name *").FillAsync(EmployeeEnglishName);
            ...
            await _page.GetByLabel("ID Issue Number").FillAsync(IDIssueNumber);



            await _page.GetByLabel("Arabic Address *").ClickAsync();

            await _page.GetByLabel("Arabic Address *").FillAsync(EmployeeArabicAddress);

            await _page.GetByLabel("Arabic Address *").PressAsync("Tab");

            await _page.GetByLabel("English Address *").FillAsync(EmployeeEnglishAddress);
            ...
            await _page.GetByLabel("Name In Bank").FillAsync(EmployeeNameonBank);

            await _page.GetByLabel("Account Number").ClickAsync();

            await _page.GetByLabel("Account Number").FillAsync(AccountNo);
            ...
            await _page.GetByLabel("ID Number *").FillAsync(EmployeeID);
            ...
            await _page.GetByLabel("Military Number *").FillAsync(MilitaryNo);
            ...
            await _page.GetByLabel("Employee Name").FillAsync(EmployeeName);
