...
namespace TF.Pages
{
    public class BanksPageWithDDT
    {
        ...
        public BanksPageWithDDT(IPage page)
        {
            _page = page;
        ...
        public async Task SeachOnBanks(string BankSearchName)
        {
            await _SearchBanksbyName.FillAsync(BankSearchName);
        ...
        public async Task CreateNewBank(string BankEnglishName)
        {
            await _BankCreate.ClickAsync();
            //  await _BankArabicName.FillAsync("11تيست");
            await _BankEnglishName.FillAsync(BankEnglishName);
