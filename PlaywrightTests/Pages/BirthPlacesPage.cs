...
namespace PlaywrightTests.Pages
{
    public class BirthPlacesPage
    {
        ...
        public BirthPlacesPage(IPage page)
        {
            _page = page;
        ...
        public async Task CreateBirthPlace()
        {
        await CreatBtn.ClickAsync();
            await ArabicName.FillAsync("العجمييييي");
            await EnglishName.FillAsync("Agmiiiiii");
