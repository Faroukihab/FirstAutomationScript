...
public class InsuranceOfficceWithDDT
{
    IPage _page;
    ...
    public InsuranceOfficceWithDDT(IPage page)
    {
        _page = page;
    ...
    public async Task CreateInsuranceOfice(string InsuranceOfficeArabicName, string InsuranceOfficeEnglishName)
    {
        await CreatBtn.ClickAsync();
        await EnglishName.FillAsync(InsuranceOfficeArabicName);
        await ArabicName.FillAsync(InsuranceOfficeEnglishName);
