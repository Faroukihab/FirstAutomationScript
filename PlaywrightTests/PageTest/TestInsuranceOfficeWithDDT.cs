...
namespace TF.PageTest
{
    ...
    [TestFixture]
    public class TestInsuranceOfficeWithDDT
    {
        ...
        public async Task TestRequstTypeCreation()
        {
            ...
            {
                string InsuranceOfficeEnglishName = data["InsuranceOfficeEnglishName"];
                string InsuranceOfficeArabicName = data["InsuranceOfficeArabicName"];

                // Create page objects
                var insuranceoffice = new InsuranceOfficceWithDDT(page);

                // Perform methods
                await insuranceoffice.EnterInsuranceOfficcesPage();
                ...
                await insuranceoffice.CreateInsuranceOfice(InsuranceOfficeEnglishName,InsuranceOfficeArabicName);
