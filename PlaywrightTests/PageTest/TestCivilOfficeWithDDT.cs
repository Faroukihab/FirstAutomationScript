...
namespace TF.PageTest
{
    ...
    [TestFixture]
    public class TestCivilOfficeWithDDT
    {
        ...
        [Test]
        public async Task TestCivilOfficeCreation()
        {
            var testData = GetTestData();

            foreach (var data in testData)
            {
                string CivilOfficeEnglishName = data["CivilOfficeEnglishName"];
                string CivilOfficeArabicName = data["CivilOfficeArabicName"];

                // Create page objects
                var civiloffice = new CivilOfficceWithDDT(page);

                // Perform methods
                await civiloffice.EnterCivilOfficcesPage();
                ...
                await civiloffice.CreateCivilOfice(CivilOfficeEnglishName,CivilOfficeArabicName);
