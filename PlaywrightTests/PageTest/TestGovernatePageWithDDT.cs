...
namespace TF.PageTest
{
    ...
    [TestFixture]
    public class TestGovernatpageWithDDT
    {
        ...
        public async Task TestRequstTypeCreation()
        {
            ...
            {
                string GovernateEnglishName = data["GovernateEnglishName"];
                string GovernateArabicName = data["GovernateArabicName"];
                string GovernateSearchName = data["GovernateSearchName"];
            

                // Create page objects
                var govddt = new GovernatesPageWithDDT(page);

                // Perform methods
                await govddt.EnterGovernatePage();
                ...
                await govddt.CreateGovernate(GovernateEnglishName, GovernateArabicName);
                await Task.Delay(2000);

                //await govddt.SearchonCountries(GovernateSearchName);
                //await Task.Delay(2000);
