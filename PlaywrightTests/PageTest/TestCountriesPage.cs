...
namespace TF.PageTest
{
    ...
    public class TestCountriesPage
    {
        ILocator Locator;
        ...
        public async Task Testlogin()
        {
            ...
            var country = new Countries(page);
          await country.EnterCountriesPage(); 
            await country.SearchonCountry();
            await page.GoBackAsync();
            await country.EnterCountriesPage();
            await country.ViewCountryPage();
