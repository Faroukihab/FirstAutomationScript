...
namespace TF.PageTest
{
    ...
    public class TestBirthPlacesPage
    {
        ILocator Locator;
       ...
       await page.SetViewportSizeAsync(1920, 1080);
            ...
            var Birth = new BirthPlacesPage(page);
           
            await   Birth.EnterBirhPlacePages();
            await Birth.CreateBirthPlace();
            await Task.Delay(2000);
            await Birth.ViewBirthPage();
            await Task.Delay(1000);
            await page.GoBackAsync();

            await Birth.EditBirhPage();
            await Task.Delay(1000);
            await page.GoBackAsync();
