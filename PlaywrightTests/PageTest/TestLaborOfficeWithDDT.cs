...
namespace TF.PageTest
{
    ...
    [TestFixture]
    public class TestLaborOfficewithDDT
    {
        ...
        public async Task TestLaborOfficeCreation()
        {
            ...
            {
                string LaborOfficeEnglishName = data["LaborOfficeEnglishName"];
                string LaborOfficeArabicName = data["LaborOfficeArabicName"];

                // Create page objects
                var labor = new LaborOfficceWithDDT(page);
                ...
                await labor.CreateLaborOfice(LaborOfficeEnglishName,LaborOfficeArabicName);
