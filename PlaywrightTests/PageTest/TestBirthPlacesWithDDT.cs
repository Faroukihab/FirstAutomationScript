...
namespace TF.PageTest
{
    ...
    [TestFixture]
    public class TestBirthPlacepageWithDDT
    {
        ...
        public async Task TestBankTransactionTypeCreation()
        {
            ...
            foreach (var data in testData)
            {
                ...
                string BirthPlaceArabicName = data["BirthPlaceArabicName"];
                string BirthPlaceEnglishName = data["BirthPlaceEnglishName"];

                // Create page objects
                var birthplace = new BirthPlacesPageWithDDt(page);

                // Perform methods
                await birthplace.EnterBirhPlacePages();
                ...
                await birthplace.CreateBirthPlace(BirthPlaceArabicName, BirthPlaceEnglishName);
