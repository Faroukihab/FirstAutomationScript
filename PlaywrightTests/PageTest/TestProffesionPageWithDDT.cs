...
namespace TF.PageTest
{
    ...
    [TestFixture]
    public class TestProffesionPagewithDDT
    {
        ...
        [Test]
        public async Task TestProffesionCreation()
        {
            var testData = GetTestData();

            foreach (var data in testData)
            {
                string ProffesionarabicName = data["proArabicName"];
                string ProffessionEnglishName = data["proEnglishName"];

                // Create page objects
                var Pro = new ProffessionWithDDT(page);
                ...
                await Pro.CreateProffesssion(ProffesionarabicName, ProffessionEnglishName);
                await Task.Delay(1000);
