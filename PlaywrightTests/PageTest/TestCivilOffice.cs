...
namespace TF.PageTest
{
    ...
    public class TestCivilOfficesPage
    {
        ILocator Locator;
        ...
        public async Task Testlogin()
        {
            ...
            var civil = new CivilOfficces(page);



            await civil.EnterCivilOfficcesPage();
            await civil.CreateCivilOfice();
            await Task.Delay(3000);
            await civil.EditCivilOffice();
            await Task.Delay(1000);
            await civil.ViewCivilOffice();
            await Task.Delay(1000);
